let allWords = [
  ...
  { word: "pencil", hint: "A writing instrument." },
  { word: "ocean", hint: "A large body of salt water." },
  { word: "robot", hint: "An intelligent machine designed to perform tasks autonomously." },
  { word: "jetpack", hint: "A device worn on the back that enables a person to fly." },
  { word: "computer", hint: "An electronic device that can store, retrieve, and process data." },
  { word: "escalator", hint: "A moving staircase used to transport people between floors." }
  ];
